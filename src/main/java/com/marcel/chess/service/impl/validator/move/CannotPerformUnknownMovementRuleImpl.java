...
@Component
public class CannotPerformUnknownMovementRuleImpl implements MoveRule {

    private MoveValidationUtil moveValidationUtil;

    public CannotPerformUnknownMovementRuleImpl(MoveValidationUtil moveValidationUtil) {
    ...
    public ValidationResult validate(Square squareFrom, Square squareTo) {
        ...
        if (MoveType.UNKNOWN.equals(moveType)) {
            return new ValidationResult(Message.MOVE_VALIDATION_CANNOT_MOVE_UNKNOWN, false);
        }
